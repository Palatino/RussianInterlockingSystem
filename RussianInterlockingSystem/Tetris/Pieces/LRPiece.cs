...
{
    public class LRPiece :Piece
    {
        public LRPiece(TetrisBoard board_)
            : base(board_, 4)
        {
            centroidColumn = (int)((board_.columns - 1) / 2.0);
            centroidRow = 0;
            configurations = new List<List<int>> {
                new List<int>() { 0, 0, 1, 0, 2, 0, 2, 1 },
                new List<int>() { 1, -1, 1, 0, 1, 1, 0, 1},
                new List<int>() { 0, -1, 0, 0, 1, 0, 2, 0 },
                new List<int>() { 2, -1, 1, -1, 1, 0, 1, 1 },
            };
